...
% Define a sentence as a list of words
sentence([good, happy, joy, sad, angry]).
% Query to determine the sentiment of the sentence
sentiment(sentence([good, happy, joy, sad, angry]), Sentiment).
Sentiment = positive.